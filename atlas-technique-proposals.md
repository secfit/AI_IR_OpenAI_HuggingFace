...
*These are draft proposals offered as a starting point for discussion with the ATLAS maintainers, not a formal submission.*

**Sources for case 2 (DSEwiki):** Ilascu, I., "OpenAI admits it didn't disclose rogue AI wiki hijacking incident," BleepingComputer, September 2026; Cloud Security Alliance, "OpenAI's Wiki Silence Tests the EU AI Act's Incident Regime," Research Note, September 6, 2026. See main report, References 11 and 15.
